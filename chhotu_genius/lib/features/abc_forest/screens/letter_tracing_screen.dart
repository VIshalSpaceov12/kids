...
class _LetterTracingScreenState extends State<LetterTracingScreen> {
  ...
  String get _currentLetter => _alphabet[_currentLetterIndex];
  ...
  void _nextLetter() {
    // Record progress for this letter
    context
        .read<ProgressProvider>()
        .recordProgress('abc_forest', 'trace_$_currentLetter', 1);
  ...
  void _prevLetter() {
    setState(() {
      if (_currentLetterIndex > 0) {
        ...
        _currentLetterIndex = _alphabet.length - 1;
      }
      _strokes.clear();
      _currentStroke = [];
    });
