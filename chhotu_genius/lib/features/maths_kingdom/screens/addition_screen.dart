...
class _AdditionScreenState extends State<AdditionScreen>
  ...
  void _generateQuestion() {
    setState(() {
      _isCorrect = null;
      _a = _random.nextInt(_maxNumber ~/ 2) + 1;
      _b = _random.nextInt(_maxNumber ~/ 2) + 1;
      _correctAnswer = _a + _b;
      _emojiA = _emojis[_random.nextInt(_emojis.length)];
      _emojiB = _emojis[_random.nextInt(_emojis.length)];
    ...
    Future.delayed(const Duration(milliseconds: 1200), () {
      ...
      if (_currentQuestion < _totalQuestions - 1) {
        ...
        context
            ...
            .recordProgress('maths_kingdom', 'addition', stars);
        setState(() {
          _showSummary = true;
        });
      }
                ...
                children: [
                    ...
                    child: AnimatedBuilder(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            // Emoji visuals (show small counts)
                            if (_a <= 10 && _b <= 10)
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Wrap(
                                    ...
                                    children: List.generate(
                                      _a,
                                      (_) => Text(_emojiA, style: const TextStyle(fontSize: 24)),
                                    ),
                                  ),
                                  Padding(
                                  ...
                                  Wrap(
                                    ...
                                    children: List.generate(
                                      _b,
                                      (_) => Text(_emojiB, style: const TextStyle(fontSize: 24)),
                                    ),
                                  ),
                                ],
                              ),
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      Color btnColor = AppColors.mathsKingdom;
                      if (_isCorrect != null) {
                        if (isThisCorrect) {
