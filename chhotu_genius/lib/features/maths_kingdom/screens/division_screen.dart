...
class _DivisionScreenState extends State<DivisionScreen>
  ...
  void _generateQuestion() {
    setState(() {
      _isCorrect = null;
      // Generate as b * quotient = a for clean division
      _b = _random.nextInt(9) + 2; // divisor 2-10
      _correctAnswer = _random.nextInt(10) + 1; // quotient 1-10
    ...
    Future.delayed(const Duration(milliseconds: 1200), () {
      ...
      if (_currentQuestion < _totalQuestions - 1) {
        ...
        context
            ...
            .recordProgress('maths_kingdom', 'division', stars);
        setState(() {
          _showSummary = true;
        });
      }
          ...
          children: [
              ...
              child: AnimatedBuilder(
                ...
                child: Container(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      // Visual: show items being grouped
                      if (_a <= 20)
                        Wrap(
                          spacing: 4,
                          runSpacing: 8,
                          ...
                          children: List.generate(
                            ...
                            (groupIdx) => Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: AppColors.mathsKingdom.withAlpha(77),
                                ),
                                borderRadius: BorderRadius.circular(8),
                              ),
                              child: Text(
                                List.generate(_b, (_) => '\u{1F534}').join(),
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                Color btnColor = const Color(0xFFAB47BC);
                if (_isCorrect != null) {
                  if (isThisCorrect) {
